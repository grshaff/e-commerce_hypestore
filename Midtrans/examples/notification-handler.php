...
if ($transaction == 'settlement') {
   ...
   mysqli_query($con,"update user_orders set status='3' , transaction_id='$transaction_id' where order_id='$order_id'");
       ...
       include "connection.php";
   mysqli_query($con,"update user_orders set status='2' where order_id='$order_id'");
 
} else if ($transaction == 'deny') {
      include "connection.php";
   mysqli_query($con,"update user_orders set status='1' where order_id='$order_id'");
